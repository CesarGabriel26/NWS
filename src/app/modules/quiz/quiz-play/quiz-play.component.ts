...
import { Quiz, QuizSettings } from '../../../models/engines/quiz';
import { Question } from '../../../models/common/question';
import { Answer } from '../../../models/common/answer';
...
export class QuizPlay implements OnInit, OnDestroy {
  act = signal<Activity>({} as Activity)
  ...
  constructor(
    ...
    private activityService: LessonsService,
  ...
  ngOnInit(): void {
    this.activatedRoute.params.subscribe(params => {
      ...
      const id = params['id'];
      const ac : Activity = this.activityService.getContent(id)


      const quiz = this.quizesService.get(ac.contentId);
